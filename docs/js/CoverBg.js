...
export default () => {
    ...
    // global vars
    let scene, camera, renderer, controls, circle, clock, uniforms,donut;
    let objects = []
    ...
    scene.background = new THREE.Color(0xF28080);
    ...
    // set up uniforms
    // uniforms are variables you set in a program and assign values to be passed to the glsl shaders
    uniforms = {
        u_time: {value: 0.0},
        u_color: { value: new THREE.Color('#8D9CF4') }
    }
